            ...
            <main className={styles.container}>
                ...
                <div className={styles.content}>
                    <p>
                        ...
                        app. You&apos;re not allowed to copy or modify the app,
                        any part of the app, or our trademarks in any way.
                        You&apos;re not allowed to attempt to extract the source
                        code of the app, and you also shouldn&apos;t try to
                        translate the app into other languages or make
                        ...
                        to tinie business private limited.
                    </p>
                    ...
                    <p>
                        ...
                        you have provided to us, to provide our Service.
                        ...
                        phone&apos;s security features and it could mean that
                        the tinie app won&apos;t work properly or at all.
                    </p>
                    ...
                    <p>
                        ...
                        device on which you&apos;re using the app, please be
                    ...
                    <p>
                        ...
                        stays charged - if it runs out of battery and you
                        can&apos;t turn it on to avail the Service, tinie
                        business private limited cannot accept responsibility.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        you&apos;ll need to download the updates if you want to
                        keep using the app. tinie business private limited does
                        not promise that it will always update the app so that
                        it is relevant to you and/or works with the Android
                        version that you have installed on your device. However,
                        you promise to always accept updates to the application
